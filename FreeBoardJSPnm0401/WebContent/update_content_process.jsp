...
<%
	...
	String title = request.getParameter("title"); // 변수 선언
	String content = request.getParameter("content");
	String b_no = request.getParameter("b_no");
	// 쿼리 만들고 delete 수행
	
	String sql = String.format("UPDATE FB_Board SET b_title = %s, b_content = %s WHERE b_no = %s",title,content,b_no); // sql문 선언(위에서 선언한 변수 활용)
	// query가 문자로 만들어 질 것.
